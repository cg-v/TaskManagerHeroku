...
var EditListComponent = /** @class */ (function () {
    function EditListComponent(route, router, taskService) {
        this.route = route;
        this.router = router;
...
var TaskViewComponent = /** @class */ (function () {
    ...
    TaskViewComponent.prototype.onlogout = function () {
        this.authService.logOut();
    };
    TaskViewComponent.ctorParameters = function () { return [
        { type: src_app_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.updateList = function (id, title) {
        return this.webRequestService.patch("lists/" + id, { title: title });
    };
...
var WebReqInterceptor = /** @class */ (function () {
    ...
    WebReqInterceptor.prototype.intercept = function (request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            console.log(error);
            if (error.status === 401 && !_this.refreshingAccessToken) {
